...
from backend.app.routers.connections import get_current_user, User
from backend.app.services.color_extraction_service import ColorExtractionService
...
async def delete_uploaded_media(
    ...
    try:
        ...
        # Delete from backend.app.database
