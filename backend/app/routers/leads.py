...
from backend.app.agents.lead_management_agent import LeadManagementAgent
...
"""
                    ...
                    from backend.app.services.token_usage_service import TokenUsageService
                ...
                if connection.data:
                    try:
                        from backend.app.routers.google_connections import send_gmail_message, User as GoogleUser
...
async def get_lead(lead_id: str, current_user: dict = Depends(get_current_user)):
    ...
    try:
        ...
        if lead.get("status"):
            # Status should already be lowercase from backend.app.database, but ensure it's proper
