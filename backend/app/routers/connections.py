...
from backend.app.routers.google_connections import handle_google_callback
...
async def post_to_facebook(
    ...
    try:
        ...
        if content_data and content_data.get('images') and len(content_data['images']) > 0:
            ...
            print(f"✅ Using image URL from backend.app.database: {image_url}")
        else:
...
async def post_to_instagram(
    ...
    try:
        ...
        # Get content data from backend.app.database using content_id
        content_id = post_data.get('content_id')
