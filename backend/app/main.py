...
from backend.app.routers.connections import router as connections_router
from backend.app.routers.content import router as content_router
from backend.app.routers.social_media import router as social_media_router
from backend.app.routers.social_media_connections import router as social_media_connections_router
...
from backend.app.routers.google_connections import router as google_router
from backend.app.routers.ads import router as ads_router
from backend.app.routers.blogs import router as blogs_router
from backend.app.routers.platform_connections import router as platform_connections_router
# Custom content router removed
from backend.app.routers.custom_blog import router as custom_blog_router
from backend.app.routers.simple_image_editor import router as simple_image_editor_router
from backend.app.routers.template_editor import router as template_editor_router
from backend.app.routers.subscription import router as subscription_router
from backend.app.routers.website_analysis import router as website_analysis_router
from backend.app.routers.trial import router as trial_router
...
from backend.app.routers.content_from_drive import router as content_from_drive_router
from backend.app.routers.admin import router as admin_router
from backend.app.routers.analytics_insights import router as analytics_insights_router
from backend.app.routers.atsn_chatbot import router as atsn_chatbot_router
from backend.app.routers.profile import router as profile_router
from backend.app.routers import document_parser
from backend.app.routers import smart_search
from backend.app.services.scheduler import start_analytics_scheduler, stop_analytics_scheduler, get_scheduler_status, trigger_analytics_collection_now
from backend.app.services.image_editor_service import image_editor_service
...
async def generate_content_for_user(
    ...
    try:
        from backend.app.middleware.credit_middleware import check_credits_before_action
...
async def run_content_generation_with_progress(user_id: str, generate_images: bool = False):
    ...
    try:
        ...
        from backend.app.agents.content_creation_agent import ContentCreationAgent
        ...
        if result and result.get('success'):
            from backend.app.middleware.credit_middleware import increment_usage_after_action
                ...
                try:
                    ...
                    if campaigns_response.data:
                        ...
                        if posts_response.data:
                            ...
                            # Import media agent
                            from backend.app.agents.media_agent import create_media_agent
                            import os
