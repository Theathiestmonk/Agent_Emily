...
class ContentCreationAgent:
    ...
    def __init__(
        ...
        try:
            from backend.app.agents.atsn import (
    ...
    async def run_weekly_generation(
        ...
        try:
            ...
            from backend.app.agents.content_strategy_engine import ContentStrategyEngine
    ...
    async def _load_user_profile(self, user_id: str) -> Dict[str, Any]:
        """Load user profile from backend.app.database"""
        try:
            profile_fields = [
    ...
    async def analyze_performance(self, user_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            from backend.app.agents.performance_learner import PerformanceLearner
    ...
    async def get_personalized_recommendations(
        ...
        try:
            ...
            from backend.app.agents.personalization_engine import PersonalizationEngine
