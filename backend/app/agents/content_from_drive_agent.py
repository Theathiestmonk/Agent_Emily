...
class ContentFromDriveAgent:
    ...
    async def check_drive_connection(self, state: ContentFromDriveState) -> ContentFromDriveState:
        ...
        try:
            ...
            # Get Google connection from backend.app.database
            ...
            from backend.app.routers.google_connections import decrypt_token, get_google_credentials_from_token, refresh_and_update_tokens
