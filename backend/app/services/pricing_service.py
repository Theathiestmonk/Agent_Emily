...
Manages pricing configuration from backend.app.database with in-memory caching for performance
"""
...
class PricingService:
    ...
    def _load_pricing_cache(self) -> None:
        """Load all active pricing from backend.app.database into memory cache"""
        try:
    ...
    def refresh_pricing_cache(self) -> bool:
        """Refresh pricing cache from backend.app.database"""
        try:
            self._load_pricing_cache()
